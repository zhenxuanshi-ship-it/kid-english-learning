...
export const allWords: Word[] = [
  ...
  { id: 19, english: 'grape', chinese: '葡萄', category: 'fruits', level: 2, difficulty: 2, emoji: '🍇', imageUrl: grapeImage, sourceAliases: ['grapes'] },
  ...
  { id: 75, english: 'noodle', chinese: '面条', category: 'food', level: 2, difficulty: 2, emoji: '🍜', sourceAliases: ['noodles'] },
  { id: 76, english: 'cookie', chinese: '饼干', category: 'food', level: 2, difficulty: 2, emoji: '🍪' },
  { id: 77, english: 'icecream', chinese: '冰淇淋', category: 'food', level: 3, difficulty: 4, emoji: '🍨', sourceAliases: ['ice cream'] },

  { id: 78, english: 'head', chinese: '头', category: 'body', level: 1, difficulty: 1, emoji: '🙂' },
  { id: 79, english: 'eye', chinese: '眼睛', category: 'body', level: 1, difficulty: 1, emoji: '👁️', sourceAliases: ['eyes'] },
  { id: 80, english: 'ear', chinese: '耳朵', category: 'body', level: 1, difficulty: 1, emoji: '👂', sourceAliases: ['ears'] },
  ...
  { id: 83, english: 'hand', chinese: '手', category: 'body', level: 1, difficulty: 1, emoji: '✋', imageUrl: handImage, sourceAliases: ['hands'] },
  { id: 84, english: 'foot', chinese: '脚', category: 'body', level: 1, difficulty: 1, emoji: '🦶', sourceAliases: ['feet'] },
  ...
  { id: 92, english: 'shoe', chinese: '鞋子', category: 'clothes', level: 1, difficulty: 1, emoji: '👟', imageUrl: shoeImage, sourceAliases: ['shoes'] },
  { id: 93, english: 'sock', chinese: '袜子', category: 'clothes', level: 1, difficulty: 1, emoji: '🧦', sourceAliases: ['socks'] },
  ...
  { id: 123, english: 'balloon', chinese: '气球', category: 'celebrations', level: 1, difficulty: 1, emoji: '🎈' },
